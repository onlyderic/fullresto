...
$merchant_website = $merchant_profile->url_website;
if(trim($merchant_website) != ''){
...
$status_dummy = ($merchant_profile->status_dummy ? 'disabled="disabled"' : '');
?>
<div class="container fullresto-detail">
    ...
    <div class="row">
                ...
                <div>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="text-right fullresto-rating <?php echo /*$favorite .*/ $rating . $price_rating; ?>" data-id="<?php echo $merchant_profile->merchant_profile_id; ?>">
                                <div class="ratings" title="<?php echo $num_rating; ?>">
                                    ...
                                    <button type="button" data-mod="favorite" class="btn btn-link btn-block no-border" <?php echo $status_dummy; ?>>
                        ...
                        <div class="tabbable">
                            <ul class="nav nav-tabs">
                                ...
                                <?php if($merchant_services) { ?>
                                <li>
                                    <a href="#menu" data-toggle="tab">What's on the Menu?</a><?php //TODO: Change label for non-F&B merchants ?>
                                </li>
                                <?php } ?>
                                <li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <table class="table table-hover table-condensed">
                                        ...
                                        <?php } ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo $currency; ?><span class="regular-price text-muted"><?php echo $serviceitem->price; ?></span><span class="discounted-price text-danger" data-price="<?php echo $serviceitem->price; ?>"></span></td>
                                            </tr>
                                        <?php
                                ...
                                <div class="text-center">
                                    <button class="btn btn-default" data-btn="make-reservation">Make a reservation now!</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <?php $this->load->view('bookingpanel', array('status_dummy' => $status_dummy)); ?>
        </div>
    </div>
</div>
